...
return {
    ...
    crafter_notify_every_tick      = true,   -- false — отключить сообщение на каждый тик, оставить только сводку
    crafter_daily_summary_interval = 86400,  -- раз в сколько секунд слать сводку (86400 = раз в сутки)
}
