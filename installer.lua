...
for _, file in ipairs(files) do
    ...
    elseif content:match("404: Not Found") then
        ...
        -- Защищаем существующие config.lua, secret.lua, crafter_data.json и
        -- .shrc от перезаписи — там могут лежать локальные настройки, вебхук,
        -- твой реальный список товаров и любые твои личные правки автозапуска.
        local target = "/home/" .. file
        if (file == "config.lua" or file == "secret.lua" or file == "crafter_data.json" or file == ".shrc")
